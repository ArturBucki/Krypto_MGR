  ...
  return (
    <div className="w-full 1000px:flex items-center">
      ...
      <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
        {/* <Image
      src={require("../../../public/assets/btcLight.png")}
      alt=""
      className="object-contain w-full h-auto 1000px:max-w-[80%] 1100px:max-w-[70%] 1500px:max-w-[60%]"
    /> */}
      </div>
      <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
        <h2 className="dark:text-white text-[#000000c7] text-[30px] px-3 w-full 1000px:text-[70px] font-[600] font-Josefin py-2 1000px:leading-[75px] 1500px:w-[60%] 1100px:w-[78%]">
          Improve Your Online Learning Experience Better Instatly
        </h2>
        <br />
        <p className="dark:text-[#edfff4] text-[#000000ac] font-Josefin font-[600] text-[18px] 1500px:!w-[55%] 1100px:!w-[78%]">
          We have 40l+ Online courses & 500k+ Online registered student. Find
          Your desired Coures from them
        </p>
        <br />
        <br />
        ...
        <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] flex items-center">
          <Image
            src={require("../../../public/assets/client_1.png")}
            alt=""
